...
public class ElementUtil {
	...
	// If the highlight it enabled then element will be highlighted
	// before the driver gets the WebElement.
	public WebElement getElement(By locator) {
		//whenever Get element will be called , it will highlight
